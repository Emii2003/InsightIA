...
const SugestoesMelhoriaRA = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.post(`https://insightiaapi-production.up.railway.app/gemini/complexa/${empresa}`);
...
export default SugestoesMelhoriaRA;
